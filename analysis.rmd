...
save(ppsm, ppsa, ppsnet, file=here::here("data", "dsripdata.rdata"))
...
```{r look}
load(here::here("data", "dsripdata.rdata"))
ppsm
...
# I think we probably want MSR_AS_OF_DT, may want to come back to that at some point, but for now, use the csv long data he created
